                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <form action="room" method="get">
                                            ...
                                            <button type="submit" class="btn btn-outline-info ${  1==1?'pushin':'btn-map-field-col'}"><h6>Book</h6></button>    
                                    </form>
                                    <form action="room" method="get">
                                        <input type="hidden" name="dom" value=""/>
                                        <button type="submit" class="btn btn-outline-info ${1==1 ?'pushin':'btn-map-field-col'}"><h6>Renew</h6></button>    
                                    </form>
                                    <form action="room" method="get">
                                        <input type="hidden" name="dom" value=""/>
                                        <button type="submit" class="btn btn-outline-info ${ 1==1?'pushin':'btn-map-field-col'}"><h6>Change</h6></button>    
                                    </form>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <form action="room" method="get">
                                                    <input type="hidden" name="dom" value=""/>
                                                    <button type="submit" class="btn btn-outline-info ${1==1 ?'pushin':'btn-map-field-col'}"style="width: 180px;margin-left: auto;margin-right: auto;display: block"><h6>Cancel</h6></button>    
                                                </form>
                                                <form action="room" method="get">
                                                    <input type="hidden" name="dom" value=""/>
                                                    <button type="submit" class="btn btn-outline-info ${ 1==1?'pushin':'btn-map-field-col'}"style="width: 180px;margin-left: auto;margin-right: auto;display: block"><h6>Change</h6></button>    
                                                </form>
                                            </div>
                                        </div>
                                    </div>
