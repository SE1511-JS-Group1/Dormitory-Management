                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <input id="chosenName" type="text" value="" style="border: none;" disabled>                                                                        
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <input id="chosenFloor" type="text" value="" style="border: none;" disabled>                                                                        
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <input id="chosenStatus" type="text" value="" style="border: none;" disabled>                                                                    
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <input id="chosenGender" type="text" value="" style="border: none;" disabled>                                                                    
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
